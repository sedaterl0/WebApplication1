<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dogrulama.aspx.cs" Inherits="WebApplication1.dogrulama" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head>
<title>Üye Doğrulama</title>
...
<div id="wrapper">
  ...
  <div id="right">
    <h2>Üye Doğrulama</h2>
    <div id="welcome">
        Lütfen e-mailinize gönderilen kodu giriniz<br />
       ...
       <td class="auto-style1"> <asp:TextBox ID="TextBox1" runat="server" Height="16px" style="margin-top: 0px" Width="138px"></asp:TextBox>
        <asp:RequiredFieldValidator ID="kullaniciadiRFV" runat="server" ControlToValidate="TextBox1"
                        ...
                        ErrorMessage="Lütfen e-mailinize gönderilen kodu giriniz"></asp:RequiredFieldValidator></td>
        <br />
        </tr>
