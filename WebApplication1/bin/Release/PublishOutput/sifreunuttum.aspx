<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sifreunuttum.aspx.cs" Inherits="WebApplication1.sifreunuttum" %>
...
<div id="wrapper">
  ...
  <div id="right">
    ...
    <div id="welcome"><table><tr> <td>Kullanıcı Adı:</td> &nbsp;
       ...
       <tr><td> E-posta:</td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
        <td><asp:TextBox ID="TextBox2" runat="server" Height="16px" Width="138px" ></asp:TextBox>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="TextBox2"

                        ErrorMessage="Eposta boş bırakılamaz"></asp:RequiredFieldValidator></td>
        <br />
           </tr>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     <tr> <td></td> <td> <asp:Button ID="Button3" runat="server" Height="22px" OnClick="Button3_Click" Text="Yolla" Width="91px" />
         &nbsp;&nbsp;&nbsp;&nbsp;<a href="üyeol.aspx"> </a><br />
