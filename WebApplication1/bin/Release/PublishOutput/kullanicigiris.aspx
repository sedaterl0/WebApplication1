<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="kullanicigiris.aspx.cs" Inherits="WebApplication1.kullanicigiris" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     <tr> <td></td> <td> <asp:Button ID="Button3" runat="server" Height="22px" OnClick="Button3_Click" Text="Giriş Yap" Width="91px" />
         &nbsp;&nbsp;&nbsp;&nbsp;<a href="üyeol.aspx"> Üye Ol</a>&nbsp;<a href="sifreunuttum.aspx" > Şifremi Unuttum</a><br />
